const CACHE='two-broke-girls-v4-1-profile-accounts';
const ASSETS=['./','./index.html','./styles.css','./app.js','./firebase.js','./manifest.webmanifest','./background.webp','./icon-192.png','./icon-512.png'];
